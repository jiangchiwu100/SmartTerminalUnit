...
static void tcpip_init_done_callback(void *arg)
{
    ...
    IP4_ADDR(&ipaddr, 192,168,60,100);
    IP4_ADDR(&netmask, 255,255,255,0);
    IP4_ADDR(&gw, 192,168,60,254);
...
//        netmask.addr = inet_addr(RT_LWIP_MSKADDR);
		...
		IP4_ADDR(&ipaddr, devif_dp83848.ip[0], devif_dp83848.ip[1], devif_dp83848.ip[2], devif_dp83848.ip[3]);
        IP4_ADDR(&gw, devif_dp83848.gateway[0], devif_dp83848.gateway[1], devif_dp83848.gateway[2], devif_dp83848.gateway[3]);
        IP4_ADDR(&netmask, devif_dp83848.netmask[0], devif_dp83848.netmask[1], devif_dp83848.netmask[2], devif_dp83848.netmask[3]);
...
INIT_ENV_EXPORT(rt_lwip_system_init);
