...
#define MAINTACE_SERVE_REMOTE_PORT	MAINTACE_SERVE_LOCAL_PORT	//维护服务远端端口号
...
//					}
	...
	FifoFree(&MaintenanceServeFifoHandle, &MaintenanceServeBuffer, &MaintenanceServeBufferPack);		/*释放接收和发送的队列所用到的动态分配的内存*/
}
