...
void LoadSwitchCtrlInit(void)
{
    ...
    for(pdrv=0; pdrv<LOAD_DEVMAXNUM; pdrv++)
    {
        ...
        case LOAD_DEV0:
            ...
            s_ComProSts[pdrv].yx.openingLocked.addr = ADDR_OPENING_LOCK;
            ...
            s_ComProSts[pdrv].yx.breakContact.value =  &g_TelesignalDB[ADDR_BREAK_CONTACT];
            s_ComProSts[pdrv].yx.closingLocked.value = &g_TelesignalDB[ADDR_CLOSING_LOCK];
            s_ComProSts[pdrv].yx.openingLocked.value = &g_TelesignalDB[ADDR_OPENING_LOCK];
            ...
            s_ComProSts[pdrv].yx.lossTrip.value = &g_TelesignalDB[ADDR_LOSS_TRIP];
            s_ComProSts[pdrv].yx.getClossing.value = &g_TelesignalDB[ADDR_GET_CLOSSING_EVENT];
            s_ComProSts[pdrv].yx.failAfterClosing.value = &g_TelesignalDB[ADDR_CLOSING_FAULT];
            s_ComProSts[pdrv].yx.earthingFaultTripU0.value = &g_TelesignalDB[ADDR_U0_EARTHING_FAULT_TRIP];
            s_ComProSts[pdrv].yx.remainClockClossing.value = &g_TelesignalDB[ADDR_REMAIN_CLOCK_CLOSSING];
            s_ComProSts[pdrv].yx.doubleProhibitClossing.value = &g_TelesignalDB[ADDR_DOUBLE_PROHIBIT_CLOSSING];
            s_ComProSts[pdrv].yx.singleLossClosing.value = &g_TelesignalDB[ADDR_SINGLE_LOSS_CLOSING_EVENT];
            s_ComProSts[pdrv].yx.breakingCurrent.value = &g_TelesignalDB[ADDR_BREAKINGCURRENT];
