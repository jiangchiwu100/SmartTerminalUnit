...
//   使能    名称	        点号                               遥信           描述
    ...
    { 1,  "远方/就地",    &g_TelesignalAddr.remoteEarth,                  NULL,          {"就地", "远方"},  {"就地->远方","远方->就地"}},
    { 1,  "短路故障",     &g_TelesignalAddr.shortCircuitFault,           NULL,          {"复位","保护"},   {"复位","保护"}},
    { 1,  "零序故障",     &g_TelesignalAddr.earthingFault,                NULL,          {"复位","保护"},   {"复位","保护"}},
    { 1,  "保护动作",     &g_TelesignalAddr.protectionAct,                NULL,          {"复位","动作"},   {"复位","动作"}},
    { 1,  "保护闭锁",     &g_TelesignalAddr.protectionLock,               NULL,          {"复位","闭锁"},   {"复位","闭锁"}},
    { 1,  "合闸闭锁",     &g_TelesignalAddr.closingLocked,                  NULL,          {"复位","闭锁"},   {"复位","闭锁"}},	
    { 1,  "分闸闭锁",     &g_TelesignalAddr.openingLocked,                  NULL,          {"复位","闭锁"},   {"复位","闭锁"}},
    { 1,  "重合动作",     &g_TelesignalAddr.recloseAct,                   NULL,          {"复位","动作"},   {"复位","动作"}},
    { 1,  "重合闭锁",     &g_TelesignalAddr.recloseLock,                  NULL,          {"复位","闭锁"},   {"复位","闭锁"}},
    { 1,  "装置故障",     &g_TelesignalAddr.deviceFault,                  NULL,          {"无","故障"},     {"无","故障"}},
    { 1,  "自检异常",     &g_TelesignalAddr.selfCheckAbnomal,            NULL,          {"无","异常"},     {"无","异常"}},
    { 1,  "通讯",         &g_TelesignalAddr.communication,                 NULL,          {"断","通"},       {"断","通"}},	
