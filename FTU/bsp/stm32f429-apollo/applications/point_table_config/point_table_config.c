...
//   使能 菜单编号   名称    上位机名称                值                             单位                 校准系数                             零漂                             死区	
    ...
    { 1,  HARMONIC,  "三次Uab",  "三次谐波Uab",    &g_TelemetryDB[THIRDHARMONIC_Uab],     "V",       &g_CalibrateFactor[CALIFACTOR_Uab],    &g_Parameter[ZERODRIFT_Uab],    &g_Parameter[DEADZONE_Uab]},	
    { 1,  HARMONIC,  "三次Ubc",  "三次谐波Ubc",    &g_TelemetryDB[THIRDHARMONIC_Ubc],     "V",       &g_CalibrateFactor[CALIFACTOR_Ucb],    &g_Parameter[ZERODRIFT_Ucb],    &g_Parameter[DEADZONE_Ucb]},
    { 1,  HARMONIC,  "三次Uca",  "三次谐波Uca",    &g_TelemetryDB[THIRDHARMONIC_Uca],     "V",       &g_CalibrateFactor[CALIFACTOR_Uac],    &g_Parameter[ZERODRIFT_Uac],    &g_Parameter[DEADZONE_Uac]},
    { 1,  HARMONIC,  "三次U0",   "三次谐波U0",     &g_TelemetryDB[THIRDHARMONIC_U0],      "V",       &g_CalibrateFactor[CALIFACTOR_U0],     &g_Parameter[ZERODRIFT_U0],     &g_Parameter[DEADZONE_U0]},
...
//    { 1,  HARMONIC,  "三次谐波UBC",   "三次谐波UBC",   &g_TelemetryDB[THIRDHARMONIC_UBC],    "V",      &g_CalibrateFactor[CALIFACTOR_UBC],    &g_Parameter[ZERODRIFT_UBC],    &g_Parameter[DEADZONE_UBC],
    { 1,  HARMONIC,  "三次Ia",    "三次谐波Ia",    &g_TelemetryDB[THIRDHARMONIC_Ia],      "A",       &g_CalibrateFactor[CALIFACTOR_Ia],     &g_Parameter[ZERODRIFT_Ia],     &g_Parameter[DEADZONE_Ia]},
    { 1,  HARMONIC,  "三次Ib",    "三次谐波Ib",    &g_TelemetryDB[THIRDHARMONIC_Ib],      "A",       &g_CalibrateFactor[CALIFACTOR_Ib],     &g_Parameter[ZERODRIFT_Ib],     &g_Parameter[DEADZONE_Ib]},
    { 1,  HARMONIC,  "三次Ic",    "三次谐波Ic",    &g_TelemetryDB[THIRDHARMONIC_Ic],      "A",       &g_CalibrateFactor[CALIFACTOR_Ic],     &g_Parameter[ZERODRIFT_Ic],     &g_Parameter[DEADZONE_Ic]},
    { 1,  HARMONIC,  "三次I0",    "三次谐波I0",    &g_TelemetryDB[THIRDHARMONIC_I0],      "A",       &g_CalibrateFactor[CALIFACTOR_I0],     &g_Parameter[ZERODRIFT_I0],     &g_Parameter[DEADZONE_I0]},	
    { 1,  HARMONIC,  "五次Uab",   "五次谐波Uab",   &g_TelemetryDB[FIFTHHARMONIC_Uab],     "V",       &g_CalibrateFactor[CALIFACTOR_Uab],    &g_Parameter[ZERODRIFT_Uab],    &g_Parameter[DEADZONE_Uab]},	
    { 1,  HARMONIC,  "五次Ubc",   "五次谐波Ubc",   &g_TelemetryDB[FIFTHHARMONIC_Ubc],     "V",       &g_CalibrateFactor[CALIFACTOR_Ucb],    &g_Parameter[ZERODRIFT_Ucb],    &g_Parameter[DEADZONE_Ucb]},
    { 1,  HARMONIC,  "五次Uca",   "五次谐波Uca",   &g_TelemetryDB[FIFTHHARMONIC_Uca],     "V",       &g_CalibrateFactor[CALIFACTOR_Uac],    &g_Parameter[ZERODRIFT_Uac],    &g_Parameter[DEADZONE_Uac]},
    { 1,  HARMONIC,  "五次U0",    "五次谐波U0",    &g_TelemetryDB[FIFTHHARMONIC_U0],      "V",       &g_CalibrateFactor[CALIFACTOR_U0],     &g_Parameter[ZERODRIFT_U0],     &g_Parameter[DEADZONE_U0]},
...
//    { 1,  HARMONIC,  "五次谐波UBC",   "五次谐波UBC",  &g_TelemetryDB[FIFTHHARMONIC_UBC],     "V",      &g_CalibrateFactor[CALIFACTOR_UBC],    &g_Parameter[ZERODRIFT_UBC],    &g_Parameter[DEADZONE_UBC]},
    { 1,  HARMONIC,  "五次Ia",    "五次谐波Ia",    &g_TelemetryDB[FIFTHHARMONIC_Ia],     "A",       &g_CalibrateFactor[CALIFACTOR_Ia],     &g_Parameter[ZERODRIFT_Ia],     &g_Parameter[DEADZONE_Ia]},
    { 1,  HARMONIC,  "五次Ib",    "五次谐波Ib",    &g_TelemetryDB[FIFTHHARMONIC_Ib],     "A",       &g_CalibrateFactor[CALIFACTOR_Ib],     &g_Parameter[ZERODRIFT_Ib],     &g_Parameter[DEADZONE_Ib]},
    { 1,  HARMONIC,  "五次Ic",    "五次谐波Ic",    &g_TelemetryDB[FIFTHHARMONIC_Ic],     "A",       &g_CalibrateFactor[CALIFACTOR_Ic],     &g_Parameter[ZERODRIFT_Ic],     &g_Parameter[DEADZONE_Ic]},
    { 1,  HARMONIC,  "五次I0",    "五次谐波I0",    &g_TelemetryDB[FIFTHHARMONIC_I0],     "A",       &g_CalibrateFactor[CALIFACTOR_I0],     &g_Parameter[ZERODRIFT_I0],     &g_Parameter[DEADZONE_I0]},		
...
//   使能  菜单编号          名称                             值                         单位      上限        下限   缺省值    数据类型  小数点位数       显示内容           备注  
    ...
    { 1,  ME_UART_COM,    "串口号",          &g_Parameter[UART_PORT],                    "-",       1,           0,     0,          2,         0,         {"串口1", "串口2"},   " "   }, 
    { 1,  ME_UART_COM,    "波特率",          &g_Parameter[UART_BAUDRATE],                "-",       4,           0,     2,          5,         0,         {"2400", "4800", "9600", "38400", "11520"},   " "   }, 
    { 1,  ME_UART_COM,    "数据位",          &g_Parameter[UART_WORDLENGTH],              "-",       9.00f,     5.00f,    9.00f,     0,         0,         {"-",  "-"         },   " "    },
    ...
    { 1,  ME_NET_COM,     "子网_4",         &g_Parameter[NET_NETMASK_3],                 "-",     255.00f,     0.00f,  255.00f,     0,         0,         {"-",  "-"         },   " "    },
