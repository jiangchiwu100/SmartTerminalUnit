...
//   使能    名称	        点号                                         遥信           描述
    ...
    { 0,  "备用2",        &g_TelesignalAddr.spareDi2,                    NULL,          {"分", "合"},      {"合->分","分->合"}},
    { 0,  "备用3",        &g_TelesignalAddr.spareDi3,                    NULL,          {"分", "合"},      {"合->分","分->合"}},
    { 0,  "备用4",        &g_TelesignalAddr.spareDi4,                    NULL,          {"分", "合"},      {"合->分","分->合"}},
    { 0,  "备用5",        &g_TelesignalAddr.spareDi5,                    NULL,          {"分", "合"},      {"合->分","分->合"}},
    { 0,  "备用6",        &g_TelesignalAddr.spareDi6,                    NULL,          {"分", "合"},      {"合->分","分->合"}},
    { 0,  "备用7",        &g_TelesignalAddr.spareDi7,                    NULL,          {"分", "合"},      {"合->分","分->合"}},
    { 0,  "备用8",        &g_TelesignalAddr.spareDi8,                    NULL,          {"分", "合"},      {"合->分","分->合"}},
    { 0,  "备用9",        &g_TelesignalAddr.spareDi9,                    NULL,          {"分", "合"},      {"合->分","分->合"}},
    { 0,  "备用10",       &g_TelesignalAddr.spareDi10,                   NULL,          {"分", "合"},      {"合->分","分->合"}},
    { 0,  "备用11",       &g_TelesignalAddr.spareDi11,                   NULL,          {"分", "合"},      {"合->分","分->合"}},
    { 0,  "备用12",       &g_TelesignalAddr.spareDi12,                   NULL,          {"分", "合"},      {"合->分","分->合"}},	
    ...
    { 1,  "遥控重合闸",   &g_TelesignalAddr.telecontrolrecloseOut,       NULL,          {"投入", "退出"},  {"退->投","投->退"}},
    { 1,  "遥控联络模式", &g_TelesignalAddr.telecontrolContactOut,       NULL,          {"联络", "分段"},  {"分段->联络","联络->分段"}},
...
//   使能          名称                  校准值	          点号                             系数值                         数据类型   系数上限值       系数下限值      系数缺省值
    ...
    { 1,    "A相电流(Ia)校准系数",       5.00f,    &g_TelemetryAddr.Ia,               &g_CalibrateFactor[CALIFACTOR_Ia],     0,    0.005f,         0.0035f,         0.00433378899f},
    { 1,    "B相电流(Ib)校准系数",       5.00f,    &g_TelemetryAddr.Ib,               &g_CalibrateFactor[CALIFACTOR_Ib],     0,    0.005f,         0.0035f,         0.00432677846f},
    { 1,    "C相电流(Ic)校准系数",       5.00f,    &g_TelemetryAddr.Ic,               &g_CalibrateFactor[CALIFACTOR_Ic],     0,    0.005f,         0.0035f,         0.00432838406f},
  ...
  #endif		
    { 1,    "线电压(Uab)校准系数",       100.00f,  &g_TelemetryAddr.Uab,              &g_CalibrateFactor[CALIFACTOR_Uab],    0,    0.02f,          0.0065f,         0.009516f},
    { 1,    "线电压(Ucb)校准系数",       100.00f,  &g_TelemetryAddr.Ucb,              &g_CalibrateFactor[CALIFACTOR_Ucb],    0,    0.02f,          0.0065f,         0.009516f},
    { 1,    "线电压(Uac)校准系数",       100.00f,  &g_TelemetryAddr.Uac,              &g_CalibrateFactor[CALIFACTOR_Uac],    0,    0.02f,          0.0065f,         0.009516f},
    { 1,    "线电压(U0)校准系数",        50.00f,   &g_TelemetryAddr.U0,               &g_CalibrateFactor[CALIFACTOR_U0],     0,    0.02f,          0.0065f,         0.009516f},
    { 1,    "线电压(UAB)校准系数",       100.00f,  &g_TelemetryAddr.UAB,              &g_CalibrateFactor[CALIFACTOR_UAB],    0,    0.02f,          0.0065f,         0.009516f},
    { 1,    "线电压(UCB)校准系数",       100.00f,  &g_TelemetryAddr.UCB,              &g_CalibrateFactor[CALIFACTOR_UCB],    0,    0.02f,          0.0065f,         0.009516f},
...
//   使能  菜单编号          名称                             值                         单位      上限        下限   缺省值    数据类型  小数点位数       显示内容           备注  
    ...
    { 1,  ME_ZERODRIFT,   "A相电流零漂",     &g_Parameter[ZERODRIFT_Ia],                "A",      99.99f,     0.00001f,   0.005f,      0,         3,         {"-",  "-"         },   " "    },	
    { 1,  ME_ZERODRIFT,   "B相电流零漂",     &g_Parameter[ZERODRIFT_Ib],                "A",      99.99f,     0.00001f,   0.005f,      0,         3,         {"-",  "-"         },   " "    },	
    { 1,  ME_ZERODRIFT,   "C相电流零漂",     &g_Parameter[ZERODRIFT_Ic],                "A",      99.99f,     0.00001f,   0.005f,      0,         3,         {"-",  "-"         },   " "    },	
    { 1,  ME_ZERODRIFT,   "零序电流零漂",    &g_Parameter[ZERODRIFT_I0],                "A",      99.99f,     0.00001f,   0.1f,        0,         3,         {"-",  "-"         },   " "    },
    { 1,  ME_ZERODRIFT,   "Uab零漂",         &g_Parameter[ZERODRIFT_Uab],               "V",      99.99f,     0.00001f,   0.1f,        0,         3,         {"-",  "-"         },   " "    },	
    { 1,  ME_ZERODRIFT,   "Ucb零漂",         &g_Parameter[ZERODRIFT_Ucb],               "V",      99.99f,     0.00001f,   0.1f,        0,         3,         {"-",  "-"         },   " "    },		
    { 1,  ME_ZERODRIFT,   "Uac零漂",         &g_Parameter[ZERODRIFT_Uac],               "V",      99.99f,     0.00001f,   0.1f,        0,         3,         {"-",  "-"         },   " "    },	
    { 1,  ME_ZERODRIFT,   "U0零漂",          &g_Parameter[ZERODRIFT_U0],                "V",      99.99f,     0.00001f,   0.1f,        0,         3,         {"-",  "-"         },   " "    },
    { 1,  ME_ZERODRIFT,   "UAB零漂",         &g_Parameter[ZERODRIFT_UAB],               "V",      99.99f,     0.00001f,   0.1f,        0,         3,         {"-",  "-"         },   " "    },	
    { 1,  ME_ZERODRIFT,   "UCB零漂",         &g_Parameter[ZERODRIFT_UCB],               "V",      99.99f,     0.00001f,   0.1f,        0,         3,         {"-",  "-"         },   " "    },	
    { 1,  ME_ZERODRIFT,   "有功功率零漂",    &g_Parameter[ZERODRIFT_P],                 "kW",     99.99f,     0.00001f,   0.0001f,     0,         3,         {"-",  "-"         },   " "    },	
    { 1,  ME_ZERODRIFT,   "无功功率零漂",    &g_Parameter[ZERODRIFT_Q],                 "kVar",   99.99f,     0.00001f,   0.0001f,     0,         3,         {"-",  "-"         },   " "    },	
    { 1,  ME_ZERODRIFT,   "视在功率零漂",    &g_Parameter[ZERODRIFT_S],                 "kVA",    99.99f,     0.00001f,   0.0001f,     0,         3,         {"-",  "-"         },   " "    },		
    { 1,  ME_ZERODRIFT,   "功率因数零漂",    &g_Parameter[ZERODRIFT_PF],                "-",      99.99f,     0.00001f,   0.001f,      0,         3,         {"-",  "-"         },   " "    },	
    { 1,  ME_ZERODRIFT,   "直流1零漂",       &g_Parameter[ZERODRIFT_DC1],               "V",      99.99f,     0.00001f,   0.1f,        0,         3,         {"-",  "-"         },   " "    },	
    { 1,  ME_ZERODRIFT,   "直流2零漂",       &g_Parameter[ZERODRIFT_DC2],               "V",      99.99f,     0.00001f,   9.9f,        0,         3,         {"-",  "-"         },   " "    },	
    { 1,  ME_ZERODRIFT,   "温度零漂",        &g_Parameter[ZERODRIFT_T],                 "°C",     99.99f,     0.00001f,   0.1f,        0,         3,         {"-",  "-"         },   " "    },	
	
    { 1,  ME_DEADEZONE,   "频率死区",        &g_Parameter[DEADZONE_F],                   "%",      99.99f,     0.01f,   5,          0,         3,         {"-",  "-"         },   " "    },	
    { 1,  ME_DEADEZONE,   "A相电流死区",     &g_Parameter[DEADZONE_Ia],                  "%",      99.99f,     0.01f,   5,          0,         3,         {"-",  "-"         },   " "    },	
    { 1,  ME_DEADEZONE,   "B相电流死区",     &g_Parameter[DEADZONE_Ib],                  "%",      99.99f,     0.01f,   5,          0,         3,         {"-",  "-"         },   " "    },	
    { 1,  ME_DEADEZONE,   "C相电流死区",     &g_Parameter[DEADZONE_Ic],                  "%",      99.99f,     0.01f,   5,          0,         3,         {"-",  "-"         },   " "    },	
    { 1,  ME_DEADEZONE,   "零序电流死区",    &g_Parameter[DEADZONE_I0],                  "%",      99.99f,     0.01f,   5,          0,         3,         {"-",  "-"         },   " "    },
    { 1,  ME_DEADEZONE,   "Uab死区",         &g_Parameter[DEADZONE_Uab],                 "%",      99.99f,     0.01f,   5,          0,         3,         {"-",  "-"         },   " "    },	
    { 1,  ME_DEADEZONE,   "Ucb死区",         &g_Parameter[DEADZONE_Ucb],                 "%",      99.99f,     0.01f,   5,          0,         3,         {"-",  "-"         },   " "    },		
    { 1,  ME_DEADEZONE,   "Uac死区",         &g_Parameter[DEADZONE_Uac],                 "%",      99.99f,     0.01f,   5,          0,         3,         {"-",  "-"         },   " "    },	
    { 1,  ME_DEADEZONE,   "U0死区",          &g_Parameter[DEADZONE_U0],                  "%",      99.99f,     0.01f,   5,          0,         3,         {"-",  "-"         },   " "    },
    { 1,  ME_DEADEZONE,   "UAB死区",         &g_Parameter[DEADZONE_UAB],                 "%",      99.99f,     0.01f,   5,          0,         3,         {"-",  "-"         },   " "    },	
    { 1,  ME_DEADEZONE,   "UCB死区",         &g_Parameter[DEADZONE_UCB],                 "%",      99.99f,     0.01f,   5,          0,         3,         {"-",  "-"         },   " "    },	
    { 1,  ME_DEADEZONE,   "有功功率死区",    &g_Parameter[DEADZONE_P],                   "%",      99.99f,     0.01f,   5,          0,         3,         {"-",  "-"         },   " "    },	
    { 1,  ME_DEADEZONE,   "无功功率死区",    &g_Parameter[DEADZONE_Q],                   "%",      99.99f,     0.01f,   5,          0,         3,         {"-",  "-"         },   " "    },	
    { 1,  ME_DEADEZONE,   "视在功率死区",    &g_Parameter[DEADZONE_S],                   "%",      99.99f,     0.01f,   5,          0,         3,         {"-",  "-"         },   " "    },		
    { 1,  ME_DEADEZONE,   "功率因数死区",    &g_Parameter[DEADZONE_PF],                  "%",      99.99f,     0.01f,   5,          0,         3,         {"-",  "-"         },   " "    },	
    { 1,  ME_DEADEZONE,   "直流1死区",       &g_Parameter[DEADZONE_DC1],                 "%",      99.99f,     0.01f,   99.99f,     0,         3,         {"-",  "-"         },   " "    },	
    { 1,  ME_DEADEZONE,   "直流2死区",       &g_Parameter[DEADZONE_DC2],                 "%",      99.99f,     0.01f,   99.99f,     0,         3,         {"-",  "-"         },   " "    },	
    { 1,  ME_DEADEZONE,   "温度死区",        &g_Parameter[DEADZONE_T],                   "%",      99.99f,     0.01f,   99.99f,     0,         3,         {"-",  "-"         },   " "    },
...
//   使能  菜单编号       名称                            值                           单位       上限        下限   缺省值     数据类型   小数点位数       显示内容           备注
    ...
    { 1,  ZERO_SEQUE,   "零序一段投退",    &g_FixedValue1[OVER_CURRENTI0_SWITCH1],        "-",       2,           0,     0,          3,         0,         {"退", "投", "告警"},   " "   },    
    ...
    { 1,  ZERO_SEQUE,   "零序二段投退",    &g_FixedValue1[OVER_CURRENTI0_SWITCH2],        " ",       2,           0,     3,          3,         0,         {"退", "投", "告警"},   " "    },    
...
//    { 1,  AUTO_RESET,   "自动复归延时",    &g_FixedValue1[AUTOMATIC_RESET_TIME],          "S",     99999.99f,   0.00f,   99,         0,         3,         {"-",  "-"         },   " "    },	
    { 1,  LIMIT_V_F,    "过电压投退",      &g_FixedValue1[OVERVOLTAGE_SWITCH],            "-",       2,           0,     0,          3,         0,         {"退", "投", "告警"},   " "    },	
    ...
    { 1,  LIMIT_V_F,    "过频投退",        &g_FixedValue1[OVERFREQUENCY_SWITCH],          "-",       2,           0,     0,          3,         0,         {"退", "投", "告警"},   " "    },	
    ...
    { 1,  LIMIT_V_F,    "低电压投退",      &g_FixedValue1[DOWNVOLTAGE_SWITCH],            "-",       2,           0,     0,          3,         0,         {"退", "投", "告警"},   " "    },	
    ...
    { 1,  LIMIT_V_F,    "低频投退",        &g_FixedValue1[DOWNFREQUENCY_SWITCH],          "-",       2,           0,     0,          3,         0,         {"退", "投", "告警"},   " "    },	
    ...
    { 1,  LOGICAL_FUN,  "闭锁分闸时间",    &g_FixedValue1[SHORT_LOCKED_OPENING_TIME],     "S",     999.99f,     0.00f,   10,         0,         3,         {"-",  "-"         },   " "   },
