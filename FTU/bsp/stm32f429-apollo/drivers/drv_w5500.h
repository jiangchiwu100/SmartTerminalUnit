/**
  ...
  */
#ifndef  __DRV_W5500_H__
#define  __DRV_W5500_H__
...
{
    struct rt_device                w5500_device;
    struct rt_spi_device *          spi_device;
    struct rt_mutex                 lock;
    void *                          user_data;
};

typedef struct spi_w5500_device *rt_spi_w5500_device_t;


/* DEFINE --------------------------------------------------------------------*/	
#ifdef DEBUG
#define W5500_PRINTF(...)                 rt_kprintf(__VA_ARGS__)
#else
#define W5500_PRINTF(...)
#endif /* DEBUG */
