...
//        0xB829u);                               
    ...
    IOMUXC_SetPinMux(IOMUXC_GPIO_B1_10_ENET_REF_CLK,1);    //����Ϊ1���������繤����������
    IOMUXC_SetPinMux(IOMUXC_GPIO_B1_14_ENET_MDC,0);                                   
    IOMUXC_SetPinMux(IOMUXC_GPIO_B1_15_ENET_MDIO,0);

    
    //���ø�λ���ж�����
    //��ת���ٶ�,��������ΪR0/5,�ٶ�Ϊ100Mhz����·�����ʹ��pull/keepr
	//ѡ��pull���ܣ�����100K Ohm���ر�Hyst
    ...
    IOMUXC_SetPinConfig(IOMUXC_GPIO_B1_07_ENET_TX_DATA00,0X110F9);                               
    IOMUXC_SetPinConfig(IOMUXC_GPIO_B1_08_ENET_TX_DATA01,0X110F9);                              
    IOMUXC_SetPinConfig(IOMUXC_GPIO_B1_09_ENET_TX_EN,0X110F9);                               
    IOMUXC_SetPinConfig(IOMUXC_GPIO_B1_10_ENET_REF_CLK,0X110F9);                                                      
	...
	IOMUXC_GPR->GPR1|=1<<23;		//ipg clk �ܿ���
}
...
* @update[2018-09-12][张宇飞][_ENET_SendFrame基础上，更改复制机制]
*/
...
* @param  uint16_t count
* @retutn [RT_ERROR] error;[RT_EOK] success.
* @update[2018-09-12][张宇飞][添加注释、添加互斥机制]
*/
        ...
        if ((status == kStatus_Success) && (link != new_link))
        {
            ...
            if (link)   // link up
            {
                ...
                if (kPHY_HalfDuplex == duplex)
                {
                    ...
                    rt_kprintf("half dumplex\n");
                }
                else
                {
                    //dbg_log(DBG_LOG, "full dumplex\n");
                    rt_kprintf("full dumplex\n");
                }
...
static int rt_hw_imxrt_eth_init(void)
{
    ...
    imxrt_eth_device.dev_addr[5] = 0xE6;
