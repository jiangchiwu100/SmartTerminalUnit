 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(StationMessage, node) < 65536 && pb_membersize(StationMessage, connect) < 65536 && pb_membersize(StationMessage, con_path[0]) < 65536 && pb_membersize(StationMessage, power_area[0]) < 65536 && pb_membersize(StationMessage, distribution) < 65536 && pb_membersize(StationMessage, fault_handle) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_node_property_connect_switch_connect_path_distribution_power_area_distribution_station_faultdeal_handle_StationMessage)
#endif
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(StationMessage, node) < 256 && pb_membersize(StationMessage, connect) < 256 && pb_membersize(StationMessage, con_path[0]) < 256 && pb_membersize(StationMessage, power_area[0]) < 256 && pb_membersize(StationMessage, distribution) < 256 && pb_membersize(StationMessage, fault_handle) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_node_property_connect_switch_connect_path_distribution_power_area_distribution_station_faultdeal_handle_StationMessage)
#endif
